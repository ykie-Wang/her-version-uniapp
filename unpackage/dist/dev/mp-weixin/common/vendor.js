...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__BE61909",
    appName: "her-vision-uniapp",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.31.59"\n    ],\n    "debugPort": 9001,\n    "initialLaunchType": "local",\n    "servePort": 7002,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"her-vision","spaceId":"mp-a99fba08-1453-457e-85e1-58a4316d1766","clientSecret":"gscjVhMHUSa3mPSO855ykg=="}]') || [];
let O = "";
try {
  O = "__UNI__BE61909";
} catch (e2) {
